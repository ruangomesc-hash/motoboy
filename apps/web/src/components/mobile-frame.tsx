...
export function MobileFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="h-dvh max-h-dvh w-full max-w-[100vw] overflow-hidden overflow-x-hidden motoboy-desktop-bg flex items-center justify-center p-0 md:p-8">
      ...
      <div
        className={cn(
          "relative w-full max-w-full min-w-0 md:max-w-[390px]",
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-h-0 min-w-0 w-full overflow-hidden overflow-x-hidden bg-background md:pt-2">
          {children}
        </div>
