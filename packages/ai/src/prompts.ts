...
- "ifood" / "i food" / "ifud" (typo) → source IFOOD.
- "99" / "99 food" / "noventa e nove" (áudio Whisper) → NINETY_NINE.
- "rappi" / "rapi" / "repi" / "rápi" / "rappy" (áudio) → RAPPI.
- Farmácia, padaria, restaurante, mercado, "entrega da [nome da loja]" SEM ifood/99/rappi → source PARTICULAR (comércio local).
...
- Não classifique loja local como iFood/99/Rappi.
